...
from layer2 import FeaturePredictor
...
class Life_Expectancy_Predictor_Engine:
    ...
    def make_prediction(self, state: str = None, county: str = None,
        ...
        life_exp = self.STACKING_MODEL.predict(stacking_model_input)
        final_prediction = FeaturePredictor()  
        return final_prediction.make_prediction(state=state, county=county, year=year, race=race, sex=sex, le=life_exp[0])   
